...
Bundled third-party components remain copyright their respective authors and are distributed under their own compatible licenses:

- Tailwind CSS and Tailwind CLI — MIT; see `assets/vendor/tailwindcss/LICENSE` and `assets/vendor/tailwindcss-cli/LICENSE`.
- Lucide — ISC; see `assets/vendor/lucide/LICENSE`.
- QRCode.js — MIT; see `assets/vendor/qrcodejs/LICENSE`.

Stripe.js is not bundled. It is loaded directly from Stripe only when a site administrator configures and enables Stripe payments.
